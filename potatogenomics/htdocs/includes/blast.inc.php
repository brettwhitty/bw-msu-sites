<script type="text/javascript" src="/js/blast_page.js"></script>
<div id="search_header">
<h3>Potato Genome Sequencing Consortium BLAST Server</h3>
</div>
<div id="search_form_div">
<form target="_blank" id="search_form" action="http://potato-blast.plantbiology.msu.edu/cgi-bin/process_blast.pl" method="post" name="blast" enctype="multipart/form-data">
...
<span style='font-size: 0.85em; color: #6F6F6F;'>BLAST databases last updated on <?php echo file_get_contents("http://potato-blast.plantbiology.msu.edu/cgi-bin/get_version.cgi"); ?></span>
</fieldset>
...
<p style='margin-top: 5px'>Please report all problems using the BLAST tool to <a href='mailto:sgr@plantbiology.msu.edu?subject=PGSC data release site comment'>sgr@plantbiology.msu.edu</a>.</p>
