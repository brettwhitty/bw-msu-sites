// ==UserScript==
// @name          Solanaceae Comparative Genomics Resource KEGG Add-on
// @namespace     http://solcomp/js/
// @description   Display cluster and expression data for Potato on KEGG pathways
/// @include       http://solanaceae.plantbiology.msu.edu/*
/// @include       http://*.com/*
// @include       http://www.genome.jp/kegg-bin/show_pathway*
// @unwrap
// ==/UserScript==
...
//injector("http://solcomp/js/kegg_overlay.js");

*/

// iterate over all image map areas
$$('area').each( function(e) {
    ...
    e.addEvent('mouseenter', function() {
        ...
        new Request.HTML({
            evalScripts:    false,
            evalResponse:   false,
            url:            'http://solcomp/cgi-bin/grp/sf_fasta.cgi?id=PUT-163a-Solanum_chacoense-17&type=expressed_sequence_assembly:PlantGDB',
            onSuccess:      function(responseTree, responseElements, responseHTML, responseJavaScript) {
                                this.set('title', responseHTML);
                            }.bind(this),
        }).get();
    });
    var o_href = e.get('href');

    //e.set('href', 'http://google.com');
    //e.set('title', "Hi, this is a tooltip");
});
